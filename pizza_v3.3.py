...
class ModelSet():
    ...
    def epsi(self,iso_i,iso_j,iso_k,x,m_i=1,m_j=1,m_k=1):
        ...
        rR_ij = self.rSMP(x,iso_i,iso_j,m_i=m_i,m_j=m_j) / self.rSTD(iso_i,iso_j)
        rR_kj = self.rSMP(x,iso_k,iso_j,m_i=m_k,m_j=m_j) / self.rSTD(iso_k,iso_j)
    ...
    def epsiLin(self,iso_i,iso_j,iso_k):
        """
        epsiLin(iso_i,iso_j,iso_k) = [ (rAbundance(iso_i,iso_j) / rSTD(iso_i,iso_j) - 1) -
                                      Q * (rAbundance(iso_k,iso_j) / rSTD(iso_k,iso_j)) -1) ] * 10^4
        ...
        rR_ij = self.ratioTwo(iso_i,iso_j) / self.rSTD(iso_i,iso_j)
        rR_kj = self.ratioTwo(iso_k,iso_j) / self.rSTD(iso_k,iso_j)
        result = ((rR_ij-1) - q*(rR_kj-1))*1e+4
